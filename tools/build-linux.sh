...
# ============================ PER-GAME CONFIG ===============================
APP_NAME="MegaManX2"
RELEASE_SLUG="MegaManX2SNESRecomp"        # matches the windows zip prefix
CMAKE_TARGET="MegaManX2SNESRecomp"
ROM_EXTS="sfc smc"
EXTRA_ARGS=""
...
REQUIRED_MOD_MANIFESTS=(
  "packages/megaman-x2.enhancement.widescreen/1.0.0/manifest.toml"
)
