<#
Package a completed Mega Man X2 Windows release build.
...
without its SDL runtime and the recomp-ui assets/ next to it):
  ...
  MegaManX2SNESRecomp-windows-x64-v<Version>.zip
...
$exeName = 'MegaManX2SNESRecomp.exe'
