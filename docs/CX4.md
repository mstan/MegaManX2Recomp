# Cx4 coprocessor — Mega Man X2

Mega Man X2 carries Capcom's **Cx4**: a Hitachi **HG51B S169** DSP. Internal
...
fetches and executes Mega Man X2's own Cx4 program out of cartridge ROM — this is
...
Measured on X2's boot self-test, the Cx4 program reads **all 1024** entries.
That makes exact table contents essential, but synthesis supplies them without
changing the instruction-level emulation path.
